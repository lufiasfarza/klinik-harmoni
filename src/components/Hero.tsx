        ...
        <div className="max-w-3xl">
          <div className="animate-fade-in">
            <div className="inline-flex items-center gap-2 bg-background/10 backdrop-blur-sm px-4 py-2 rounded-full border border-primary-foreground/20 mb-6">
              ...
              <span className="text-sm text-primary-foreground font-medium">{t('hero.badge')}</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-heading font-bold text-primary-foreground mb-6 leading-tight">
              {t('hero.title')} <span className="block text-primary-light">{t('hero.titleHighlight')}</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-6 max-w-2xl">
              <div className="text-center p-4 bg-background/10 backdrop-blur-sm rounded-xl border border-primary-foreground/20 hover:bg-background/20 transition-all duration-300">
                ...
                <div className="text-sm text-primary-foreground/80">{t('hero.branches')}</div>
              </div>
              <div className="text-center p-4 bg-background/10 backdrop-blur-sm rounded-xl border border-primary-foreground/20 hover:bg-background/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-heading font-bold text-primary-foreground mb-1">50+</div>
                <div className="text-sm text-primary-foreground/80">{t('hero.specialists')}</div>
              </div>
              <div className="text-center p-4 bg-background/10 backdrop-blur-sm rounded-xl border border-primary-foreground/20 hover:bg-background/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-heading font-bold text-primary-foreground mb-1">10K+</div>
                <div className="text-sm text-primary-foreground/80">{t('hero.happyPatients')}</div>
              </div>
            </div>
          </div>
        </div>
